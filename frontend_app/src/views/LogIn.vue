<template>
    <div class=" min-h-screen bg-gray-100">
        <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ">
            <div class="max-w-md w-full space-y-8 border border-gray-200 rounded px-4 py-6 bg-white">
                <div>
                ...
                <form class="mt-8 space-y-6" action="#"  @submit.prevent="login">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                            ...
                            <router-link to="/sign-up" class="text-purple-600 hover:text-purple-700 focus:text-purple-700 transition duration-200 ease-in-out">Register</router-link>
                        </p>
                    </div>
                </form>
            </div>
